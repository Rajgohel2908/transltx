...
const ParkingTab = ({ parkingLots, formMode, setFormMode, editingParking, setEditingParking, closeAllForms, handleParkingSaved, handleDeleteParkingLot, isSubmitting }) => {
    return (
        <div>
